<template>
  <div id="moneyAccess">
    <el-button type="success" @click="dialogVisible = true"  icon="caret-right">资金中心调拨已分配资金 Dialog</el-button>

    <el-dialog title="基金产品账户调拨已分配资金" :visible.sync="dialogVisible" size="small" :before-close="handleClose">
      <div class="con-box">
        <div class="left-box">
          <h3>{{lefttableData.account}}&nbsp;{{lefttableData.accountName}}</h3>
